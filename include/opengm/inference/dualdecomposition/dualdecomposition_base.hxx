...
*/
   ...
   protected:
      ...
      template<class ACC> void getBounds(const std::vector<std::vector<typename SubGmType::LabelType> >&, const std::vector<SubVariableListType>&, ValueType&, ValueType&, std::vector<LabelType>&);
...
///////////////////////////////////////////////
   ...
   (
      const std::vector<std::vector<typename SubGmType::LabelType> >& subStates,
