...
FIND_PATH(OSI_PACKED_MATRIX_INCLUDE_DIR CoinPackedMatrix.hp
  HINTS ${OSI_ROOT_DIR}/include/coin
  HINTS ${OSI_INCLUDE_DIR}/coin
)
...
IF(OSI_FOUND)
   ...
   SET(OSI_BASE_LIBRARIES "${OSI_UTILS_LIBRARY};${OSI_LIBRARY}")
   #CLP
   IF(CLP_LIBRARY AND OSI_CLP_LIBRARY AND OSI_CLP_INCLUDE_DIR)
      SET(OSI_CLP_INCLUDE_DIRS "${OSI_GLPK_INCLUDE_DIR};${OSI_PACKED_MATRIX_INCLUDE_DIR}")
   ...
   SET (OSI_SOLVER_INCLUDE_DIRS "${OSI_CLP_INCLUDE_DIRS};${OSI_GLPK_INCLUDE_DIRS}")
   #combine all libs
   SET(OSI_INCLUDE_DIRS "${OSI_BASE_INCLUDE_DIRS};${OSI_SOLVER_INCLUDE_DIRS}")
