...
from opengmcore._opengmcore  import  SparseFunction,AbsoluteDifferenceFunction,SquaredDifferenceFunction,\
                              TruncatedAbsoluteDifferenceFunction,TruncatedSquaredDifferenceFunction,\
                              PottsFunction,PottsNFunction,PottsGFunction
...
def relabeledPottsFunction(shape,relabelings,valueEqual=0.0,valueNotEqual=1.0,dtype=numpy.float32):
