...
#define GraphicalModelDecomposition DualDecompostionMeritInference_GraphicalModelDecomposition
...
#include <param/dual_decompostion_merit_param.hxx>
...
void export_dual_decomposition_merit(){
...

   {
      ...
      typedef opengm::DualDecompositionMerit<GM,SubInfernce,DualBlockType> PyDualDecomposition;

      exportInfParam<exportTag::NoSubInf,SubInfernce>("_SubParameter_DualDecompositionMerit_DynamicProgramming");
      exportInfParam<exportTag::NoSubInf,PyDualDecomposition>("_DualDecompositionMerit_DynamicProgramming");
      // export inferences
      class_< PyDualDecomposition>("_DualDecompositionMerit_DynamicProgramming",init<const GM & >())  
      .def(InfSuite<PyDualDecomposition,false>(std::string("DualDecompositionMerit"),setup))
      ;
...
template void export_dual_decomposition_merit<GmAdder,opengm::Minimizer>();
